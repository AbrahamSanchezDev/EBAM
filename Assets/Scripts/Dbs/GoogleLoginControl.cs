...
{
    [System.Serializable]
    public class OnUserLoaded : UnityEvent<FirebaseUser>
    {
    }

    public class GoogleLoginControl : MonoBehaviour
    {
        ...
        {
            var curUser = FirebaseAuth.DefaultInstance.CurrentUser;
            OnUserLoadedEvent?.Invoke(curUser);
        }
        ...
        public string webClientId = "901758928354-ahedg2a6s7bcmiottm0bjdljvfc5tbqv.apps.googleusercontent.com";
